...
- Start from a pretrained checkpoint (e.g., `yolov8n.pt`).
...
- Ultralytics provides simple commands to train, validate, and export models for fisheries detection tasks.
